<div class='flex flex-wrap items-center w-full lg:gap-y-2 gap-y-4 gap-x-4'>
    <a href="javascript:void(0)"><img src="{{ asset('img/nizar-khan.png') }}" alt="logo" class='h-10 w-18' />
    </a>
    ...
    <div id="collapseMenu"
        ...
        <button id="toggleClose" class='lg:hidden fixed top-5 right-4 z-[100] rounded-full bg-white p-4 '>
        ...
        <ul
            class='tracking-tight lg:ml-12 lg:flex lg:gap-x-8 max-lg:space-y-3 max-lg:fixed max-lg:bg-slate-900 max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 uppercase'>
            <li class='hidden mb-6 max-lg:block'>
                <a href="#"><img src="{{ asset('img/nizar-khan.png') }}" alt="logo" class='h-10 w-18' />
                </a>
            </li>
            <li class='max-lg:border-b max-lg:py-3'><a href='#home'
                    class='hover:text-primary text-third block font-bold text-[15px]'>Home</a>
            </li>
    ...
    <div class='flex ml-auto space-x-3'>
        ...
        <!-- Github -->
        <a href="https://github.com/NizarKhan0" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="white"
                viewBox="0 0 30 30">
                <path
        ...
        <!-- Linkedin -->
        <a href="https://www.linkedin.com/in/nizar-khan/" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="white"
                viewBox="0 0 50 50">
                <path
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/60187898521" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="white"
                viewBox="0 0 50 50">
                <path
