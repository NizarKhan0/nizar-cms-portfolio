<div class="grid max-w-screen-lg grid-cols-1 gap-10 mx-auto sm:grid-cols-2">
        ...
        <div>
            ...
            <ul class="mt-10 space-y-6">
                <li class="flex items-center">
                    ...
                    <a href="javascript:void(0)" class="ml-3 text-sm text-slate-300">
                        <small class="block">Tel</small>
                        <strong>{{ $contact->number_phone }}</strong>
                    </a>
                </li>
                <li class="flex items-center">
                    <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
    ...
    {{-- <div class="max-w-md md:ml-auto">
        <h4 class="text-lg font-extrabold uppercase text-primary">Contact
            Us</h4>
        <p class="mt-2 text-sm text-slate-400"></p>
        <form class="mt-6">
            <input type='text' placeholder='Name'
                class="w-full rounded-md h-10 px-6 bg-[#f0f1f2] text-sm mb-3 outline-primary" />
            <input type='text' placeholder='Email'
                class="w-full rounded-md h-10 px-6 bg-[#f0f1f2] text-sm mb-3 outline-primary" />
            <textarea placeholder='Message' rows="6" class="w-full rounded-md px-6 bg-[#f0f1f2] text-sm pt-3 outline-primary"></textarea>
        </form>
        <button type='button'
            class="block w-full px-6 py-3 mt-3 text-sm font-semibold text-white rounded-2xl bg-primary hover:bg-teal-500">Submit</button>
    </div> --}}

    <div class="container px-4 mx-auto">
        <div class="max-w-md md:ml-auto">
            <h4 class="text-lg font-extrabold uppercase text-primary">Contact Us</h4>
            ...
            <form id="contactForm" class="mt-6">
                ...
                <textarea name="message" id="message" placeholder='Message' rows="6" required
                    class="w-full rounded-md px-6 bg-[#f0f1f2] text-sm pt-3 outline-primary"></textarea>
                <div class="mb-3">
                    <input type="checkbox" id="securityCheckbox" required>
                    <label for="securityCheckbox" class="text-white">I agree to the terms and conditions</label>
                </div>

                <div id="formErrors" class="mb-3 text-red-500"></div>

                <button type='submit' onclick="sendEmail(event)"
                    class="block w-full px-6 py-3 mt-3 text-sm font-semibold text-white rounded-2xl bg-primary hover:bg-teal-500">
                    Send Email
                </button>
            </form>
